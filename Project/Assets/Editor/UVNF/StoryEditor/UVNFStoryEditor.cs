                            ...
                            for (int i = 0; i < currentElements.Count; i++)
                            {
                                ...
                                if (currentElements[i].IsVisible())
                                {
                                    if (storyElementsFoldout[i])
                                    {
                                        ...
                                        {
                                            GUILayout.Space(40f);
                                            GUILayout.BeginVertical(UVNFSettings.EditorSettings.UVNFSkin.box, GUILayout.MaxWidth(700));
                                            {
                                                ...
                                                GUILayout.BeginVertical(style);
                                                {
                                                    GUILayout.Space(20);
                                                    Rect lastRect = GUILayoutUtility.GetLastRect();
                                                    currentElements[i].DisplayLayout(GUILayoutUtility.GetLastRect(), UVNFSettings.GetElementStyle(currentElements[i].Type));
